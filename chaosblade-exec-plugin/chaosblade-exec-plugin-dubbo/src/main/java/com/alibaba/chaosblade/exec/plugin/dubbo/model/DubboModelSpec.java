            ...
            if (action instanceof DelayActionSpec) {
                ...
                action.setExample(Example.builder()
                        .addExampleCommand(ExampleCommand.builder()
                                .setAnnotation("Invoke com.alibaba.demo.HelloService.hello() service, do delay 3 seconds experiment")
                                .setCommand("blade create dubbo delay --time 3000 --service com.alibaba.demo.HelloService --methodname hello --consumer")
                                .build()
                        ).build());
                ...
                action.setExample(Example.builder()
                        .addExampleCommand(ExampleCommand.builder()
                                .setAnnotation("Invoke com.alibaba.demo.HelloService.hello() service, do throws customer exception")
                                .setCommand("blade create dubbo throwCustomException --exception java.lang.Exception --service com.alibaba.demo.HelloService --methodname hello --consumer")
                                .build()
                        ).build());
                ...
                action.setExample(Example.builder()
                        .addExampleCommand(ExampleCommand.builder()
                                .setAnnotation("Do a full load experiment on the Dubbo provider thread pool")
                                .setCommand("blade c dubbo threadpoolfull --provider")
                                .build()
                        ).build());
            }
        }
