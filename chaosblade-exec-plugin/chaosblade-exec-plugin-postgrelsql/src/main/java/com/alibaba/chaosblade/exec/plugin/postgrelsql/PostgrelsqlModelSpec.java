    ...
    private void addActionExample() {
        ...
        for (ActionSpec action : actions) {
            if (action instanceof DelayActionSpec) {
                ...
                action.setExample(Example.builder()
                        .addExampleCommand(ExampleCommand.builder()
                                .setAnnotation("Do a delay 2s experiment for Postgrelsql client INSERT statement")
                                .setCommand("blade create psql delay --sqltype insert --time 4000")
                                .build()
                        ).build());
            }
            if (action instanceof ThrowCustomExceptionActionSpec) {
                ...
                action.setExample(Example.builder()
                        .addExampleCommand(ExampleCommand.builder()
                                .setAnnotation("Do a throws custom exception experiment for Postgrelsql client INSERT statement")
                                .setCommand("blade create psql throwCustomException --sqltype insert --exception java.lang.Exception")
                                .build()
                        ).build());
            }
        }
